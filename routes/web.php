...
Route::get('/{slug}', [App\Http\Controllers\WebsiteContentController::class, 'show'])->where('slug', 'terms-of-service|privacy-policy|gdpr|security|careers|help-center|guides');
