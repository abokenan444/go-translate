@extends('layouts.app')
@section('title', 'Affiliate - CulturalTranslate')
@section('content')
<section class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-5xl font-bold mb-4">Affiliate</h1>
...
<section class="bg-gray-100 py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl text-gray-600 mb-8">Experience CTS™ certified translation with cultural intelligence</p>
