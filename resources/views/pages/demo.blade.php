...
@section('title', 'Live Demo - Try Cultural Translation')
@section('meta_description', 'Experience cultural translation in action. Test our API with real translation, webhooks, and company integration features.')
    ...
    <section class="py-16 px-4">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <h1 class="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                Experience Cultural Translation
                <span class="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 mt-2">In Real-Time</span>
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12">
                Test our advanced API with live translation, webhook integration, and company-specific features. See why businesses trust Cultural Translate.
            </p>
        </div>
    </section>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div class="mt-4 grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Source Language</label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Target Language</label>
                            ...
                            <div class="mt-4">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Target Culture</label>
                                <select x-model="targetCulture" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                                    <option value="saudi_arabia">Saudi Arabia (Formal)</option>
                                    <option value="egypt">Egypt (Conversational)</option>
                                    <option value="morocco">Morocco (Friendly)</option>
                                    <option value="usa">USA (American English)</option>
                                    <option value="uk">UK (British English)</option>
                                    <option value="spain">Spain (Castilian)</option>
                                    <option value="mexico">Mexico (Latin American)</option>
                                </select>
                            </div>
                            ...
                            >
                                <span x-show="!loading">✨ Translate with Cultural Adaptation</span>
                        ...
                        <div>
                            ...
                            <div class="w-full h-48 px-4 py-3 border-2 border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-900/20 rounded-lg dark:text-white overflow-y-auto">
                                <span x-show="!translatedText" class="text-gray-500 dark:text-gray-400">Translation will appear here...</span>
                                <span x-text="translatedText"></span>
                            </div>
                            ...
                            <div x-show="culturalInsights.length > 0" class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-300 dark:border-blue-700 rounded-lg">
                                <h4 class="font-semibold text-blue-900 dark:text-blue-300 mb-2">🎯 Cultural Adaptations Applied:</h4>
                            ...
                            <div x-show="apiResponse" class="mt-4">
                                <details class="bg-gray-100 dark:bg-gray-700 rounded-lg p-4">
                                    <summary class="cursor-pointer font-semibold text-gray-700 dark:text-gray-300">📡 API Response</summary>
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.culturalInsights = data.data.cultural_insights || [
                        'Formal tone adjusted for ' + this.targetCulture,
                        'Cultural idioms adapted',
                        'Honorifics applied based on target culture'
                    ];
