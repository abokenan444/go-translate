    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <a href="{{ route('enterprise.request') }}" class="block w-full text-center bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition">Get Started</a>
            </div>
            ...
            <div class="bg-indigo-600 rounded-lg shadow-lg p-8 text-white transform scale-105">
                ...
                <ul class="space-y-3 mb-8">
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-indigo-200 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                ...
                <a href="{{ route('enterprise.request') }}" class="block w-full text-center bg-white text-indigo-600 py-3 rounded-lg hover:bg-gray-100 transition font-semibold">Get Started</a>
            </div>
