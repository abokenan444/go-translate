...
use App\Notifications\PartnerApplicationReceivedNotification;
...
class PartnerApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $application = PartnerApplication::find($applicationId);
            ...
            $application->notify(new PartnerApplicationReceivedNotification($application));
