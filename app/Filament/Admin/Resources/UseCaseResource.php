...
use App\Filament\Admin\Resources\UseCaseResource\Pages;
use App\Filament\Admin\Resources\UseCaseResource\RelationManagers;
...
class UseCaseResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewUseCase::route('/{record}'),
